...
class UserStore {
  ...
  @action
  resetProfile = () => {
    this.id = reset.reset_id;
    this.username = reset.reset_username;
    this.full_name =reset.reset_full_name;
    this.group_name = reset.reset_group_name;
    this.role = reset.reset_role;
    this.register_date = reset.reset_register_date;
    this.email = reset.reset_email;
    this.slack_username = reset.reset_slack_username;
    this.freecodecamp_username = reset.reset_freecodecamp_username;
    this.mobile = reset.reset_mobile;
    this.group_id = reset.reset_group_id;
  };
  @action
  searchUser = event => {
  ...
  setState = (user) => {
    ...
    reset = {
      ...
      reset_freecodecamp_username: user.reset_freecodecamp_username,
