...
export const ISSTUDENT_STATE_CHANGED = 'ISSTUDENT_STATE_CHANGED';
export const AVATAR_URL_CHANGED = 'AVATAR_CHANGED';
export const HISTORY_CHANGED = 'HISTORY_CHANGED';
export const USER_ID = 'USER_ID';
export const IS_EMAIL_EXISTED = 'IS_EMAIL_EXISTED';
...
export const ALL_TEACHERS_CHANGED = 'ALL_TEACHERS_CHANGED';
export const INFO_SELECTED_MODULE_CHANGED = 'INFO_SELECTED_MODULE_CHANGED';
