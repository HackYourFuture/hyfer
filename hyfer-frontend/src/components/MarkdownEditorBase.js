...
class MarkdownEditorBase extends Component {
...
MarkdownEditorBase.propTypes = {
  classes: PropTypes.object.isRequired,
  markdown: PropTypes.string.isRequired,
  onChange: PropTypes.func.isRequired,
};

MarkdownEditorBase.defaultProps = {
  onChange: () => undefined,
};

export default withStyles(styles)(MarkdownEditorBase);
