...
class TrainTicket extends Component {
  ...
  filterStudents = () => {
    ...
    const remainingCards = couponCodes.filter(e => !reservedTickets.includes(e));
  ...
  render() {
    ...
    const isEnabled =
      senderName.length > 0 && couponCodes.length > 0 &&
      ...
      <div>
        ...
        <div className={Styles.footer}>
          <ul className={Styles.btnList}>
            <li>
              <button className={stepIndex === 0 || stepIndex === 3 ? Styles.displayNone : Styles.back}
            ...
            <li>
              <button className={`${stepIndex > 1 ? Styles.displayNone : Styles.next}
              ...
              <button className={stepIndex === 2 ? Styles.next : Styles.displayNone}
              ...
              <button className={stepIndex === 3 ? Styles.next : Styles.displayNone}
