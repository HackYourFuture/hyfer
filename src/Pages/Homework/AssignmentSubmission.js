...
export default class AssignmentSubmission extends Component { 
    ...
    render() {
        ...
        const submitter = students.filter(student => student.username === submitterName)[0] || currentUser
        const submissionReviews = reviews.filter(review => review.submission_id === id)
