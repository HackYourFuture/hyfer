        ...
        return (
            <ModalDialog visible={this.props.visible} closeClicked={this.props.onCancel} title={this.props.title}>
                <div>
                    ...
                    <div className={style.ModuleRow}>
                        <button className={`${style.textButton} ${style.cancelButton}`} onClick={this.props.onCancel}>
                            CANCEL
                        </button>
                        <button className={`${style.textButton} ${style.addButton}`} disabled={!this.isFormValidate()} onClick={this.addModule}>
